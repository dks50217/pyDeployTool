...
class Ui_window(object):
    ...
    def retranslateUi(self, window):
        ...
        window.setWindowTitle(_translate("window", "pyDeployTool"))
        #window.setMinimumSize()
        self.bSelectMedia.setText(_translate("window", "選擇檔案"))
        self.bConvert.setText(_translate("window", "開始換版"))
        self.bOpenOutputFolder.setText(_translate("window", "打開換版資料夾"))
        self.bSelectOutputFolder.setText(_translate("window", "換版資料夾"))
        self.groupBox.setTitle(_translate("window", "換版清單"))
        self.bRemoveFile.setText(_translate("window", "移除檔案"))
        self.bCancel.setText(_translate("window", "取消"))
        self.chbxOpenOutputFilesAuto.setText(_translate("window", "輸出完成自動打開換版資料夾"))
        ...
        self.actionAbout_pyTranscriber.setText(_translate("window", "&關於 pyDeployTool"))
